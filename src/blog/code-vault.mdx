...
**Interactive fuzzy finder.** Running `vault get` without arguments opens an interactive search with live preview. Arrow keys to browse, enter to select the snippet shows up with full syntax highlighting.
...
*Built with Go, PostgreSQL, and SeaweedFS. [Check it out on GitHub →](https://github.com/rodrigomsrocha/code-vault)*
